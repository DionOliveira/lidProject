  ...
  <body>
    ...
    <!-- END nav -->
      ...
      <div class="container">
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      <input type="password" class="form-control" placeholder="Comfirm Password" name="cpassword">
 																	...
 																	<div class="col-md-12">
                                    <div class="form-group">
                                      <input type="ema" class="form-control " placeholder="E-Mail" name="email">
																			<small id="textEmail"></small>
                                    </div>
                                  </div>
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      <input type="submit" value="Create" class="btn btn-dark py-3 px-4">
		...
		<script src="js/valid-register.js"></script>
