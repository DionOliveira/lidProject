  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item"><a href="index.php" class="nav-link">Home</a></li>
			      ...
			      <li class="nav-item active"><a href="changepw.php" class="nav-link">Change Password</a></li>
    ...
    <!-- END nav -->
      ...
      <div class="container">
                        ...
                        <div class="container">
                          <div class="row d-md-flex justify-content-end">
                            <div class="col-md-12 col-lg-6 half p-3 py-5 pl-lg-5 ftco-animate heading-section heading-section-white">
                              ...
                              <form action="changepw_exec.php" method="POST">
                                <div class="row">
                                  <div class="col-md-12">
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      <input type="password" class="form-control" placeholder="Comfirm Password" name="cpassword">
																			<small id="textCPassword"></small>	
                                    </div>
                                  </div>
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      <input type="submit" value="Change" class="btn btn-dark py-3 px-4">
																			<h4><small id="textForm"></small></h4>
                                      <h4>  
                                        <center>
                                          <?php
                                            if (isset($_SESSION["msgpw"])){
                                              echo $_SESSION["msgpw"];
																							$_SESSION["msgpw"] ="";
																							echo $_SESSION["msgpw"];
                                            }
		...
		<script src="js/valid-change.js"></script>
